...
function showBootError(error) {
  ...
  box.innerHTML = `<strong>PRIME RPG boot error</strong><span>${escapeHTML(message)}</span><small>JS упал при старте. Открой сайт с ?v=2.1.1 или очисти данные сайта.</small>`;
