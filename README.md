...
```text
https://coldqh.github.io/LifeRPG/?v=0.9.0
```
...
- Компактный мобильный UI примерно в 2 раза плотнее.
- Более чистый профессиональный habit tracker-дизайн.
- Нижняя навигация на телефонах.
- Меньше отступы, карточки, заголовки и кнопки.
- Квесты и недельные блоки стали плотнее и быстрее для отметки.
